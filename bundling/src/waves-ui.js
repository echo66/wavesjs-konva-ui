...
import KonvaMouseSurface from './interactions/konva-mouse-surface';
...
export default {
  ...
  behaviors: {
    ...
    TimeContextBehavior, TraceBehavior, WaveformBehavior, SimpleSnapSegmentBehavior
  },
  interactions: { EventSource, Keyboard, KonvaMouseSurface, WaveEvent, KonvaWaveEvent },
  states: {
    ...
    HorizontalSelectionState, CenteredScrollState
  },
  // helpers: {
